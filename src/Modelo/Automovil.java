...
public class Automovil extends Vehiculo_terrestre{
    private String traccion, suspension, puertas, ventanas;

    public Automovil(){}

    public Automovil(String traccion, String suspension, String puertas, String ventanas, String asientos, String llantas, String placa, String chasis, String tipo_frenos, String modelo, String marca, String linea, String motor, String color, String cilindros, String tipo, String precio_venta) {
